...
selected_features = ['smoking_status', 'CEACAM5', 'MUC-16']
#selected_features = ['smoking_status', 'CEACAM5', 'MUC-16', 'CXL17', 'WFDC2', 'hK14']
df['smoking_status'] = df['smoking_status'].fillna('missing')

preprocessor = ColumnTransformer([
    ('cat', OneHotEncoder(drop='first'), ['smoking_status'])  # Encode categorical features
